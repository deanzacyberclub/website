    ...
    >
      <div className="max-w-5xl mx-auto px-6 pb-6">
        ...
        <div className="border-b border-gray-200 dark:border-matrix/20 py-4">
          <div className="flex items-center justify-between font-mono text-[10px] text-gray-500 dark:text-gray-600 uppercase tracking-wider flex-wrap gap-2">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="font-mono text-xs text-gray-600 dark:text-gray-500 leading-relaxed">
                De Anza Cybersecurity Club — hands-on workshops, CTF
                competitions, and industry certifications for students of all
                skill levels.
              </p>
            </div>
