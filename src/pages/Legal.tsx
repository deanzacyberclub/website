...
function TermsContent() {
  return (
    <>
      <section>
        <h2 className="text-lg font-semibold text-matrix mb-3">
      ...
      <section>
        ...
        <ul className="text-gray-400 space-y-2 ml-4">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong className="text-matrix">Spamming:</strong> Sending
          ...
          <li className="flex items-start gap-2">
            <span className="text-hack-red">-</span>
            <span>
              <strong className="text-matrix">Illegal Activities:</strong> Using
          ...
          <li className="flex items-start gap-2">
            <span className="text-hack-red">-</span>
            <span>
              <strong className="text-matrix">Abuse:</strong> Harassing,
          ...
          <li className="flex items-start gap-2">
            <span className="text-hack-red">-</span>
            <span>
              <strong className="text-matrix">Misrepresentation:</strong>{" "}
    ...
    <>
      <section>
        ...
        <ul className="text-gray-400 space-y-2 ml-4">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong className="text-matrix">Account Information:</strong> When
          ...
          <li className="flex items-start gap-2">
            <span className="text-hack-cyan">-</span>
            <span>
              <strong className="text-matrix">Linked Social Accounts:</strong>{" "}
      ...
      <section>
        ...
        <p className="text-gray-400 leading-relaxed mb-3">
          ...
          <strong className="text-matrix">club administration purposes</strong>,
          including:
        </p>
        <ul className="text-gray-400 space-y-2 ml-4">
          <li className="flex items-start gap-2">
      ...
      <section>
        ...
        <ul className="text-gray-400 space-y-2 ml-4">
          <li className="flex items-start gap-2">
            <span className="text-hack-cyan">-</span>
            <span>
              <strong className="text-matrix">GitHub</strong> - We receive your
          ...
          <li className="flex items-start gap-2">
            <span className="text-hack-cyan">-</span>
            <span>
              <strong className="text-matrix">Discord</strong> - We receive your
              username, email, and avatar
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-hack-cyan">-</span>
            <span>
              <strong className="text-matrix">LinkedIn</strong> - We receive
