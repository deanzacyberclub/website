...
╚═════╝ ╚═╝  ╚═╝ ╚═════╝ ╚═════╝`}
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 w-full">
          <p className="font-mono text-sm text-gray-600 dark:text-matrix/60 mb-6">
            <span className="text-blue-700 dark:text-matrix">&gt;</span> ./ctf
            --compete --tracks=3
          </p>
          ...
          <div className="flex flex-wrap items-center gap-6 text-gray-600 dark:text-gray-400 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="font-terminal">Saturday, May 15, 2026</span>
            </div>
            <div className="flex items-center gap-2">
              <Clock className="w-5 h-5 text-blue-600 dark:text-matrix" />
              <span className="font-terminal">12:00 PM - 6:00 PM</span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-4 gap-3 max-w-sm">
            {[
              ...
              <div key={label} className="border border-blue-300 dark:border-matrix/30 bg-blue-50 dark:bg-matrix/5 p-3 text-center">
                <div className="text-2xl font-bold font-mono text-blue-700 dark:text-matrix tabular-nums">
                  {String(value).padStart(2, "0")}
                </div>
                <div className="text-[10px] text-gray-500 dark:text-gray-600 font-terminal mt-1">
                  {label}
                </div>
              </div>
            ))}
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="card-hack p-6 text-center group hover:border-blue-400 dark:hover:border-matrix/50 transition-all">
                ...
                <div className="text-3xl font-bold text-yellow-600 dark:text-matrix mb-2">
                  $500+
                </div>
              ...
              <div className="card-hack p-6 text-center group hover:border-blue-400 dark:hover:border-matrix/50 transition-all">
                ...
                <div className="text-3xl font-bold text-blue-600 dark:text-matrix mb-2">
                  100+
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-500 font-terminal">
                  PARTICIPANTS
              ...
              <div className="card-hack p-6 text-center group hover:border-blue-400 dark:hover:border-matrix/50 transition-all">
                ...
                <div className="text-3xl font-bold text-purple-600 dark:text-matrix mb-2">
                  3
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-500 font-terminal">
                  TRACKS
              ...
              <div className="card-hack p-6 text-center group hover:border-blue-400 dark:hover:border-matrix/50 transition-all">
                ...
                <div className="text-3xl font-bold text-green-600 dark:text-matrix mb-2">
                  6
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-500 font-terminal">
                  HOURS
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="terminal-window">
              ...
              <div className="terminal-body space-y-6">
                <div>
                  <h3 className="text-blue-600 dark:text-matrix font-bold mb-2">
                    Format
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    This is a jeopardy-style CTF competition held in-person at
                    De Anza College. Participants will solve challenges across
                    three tracks to earn points, with the team accumulating the
                    most points by the end of the competition winning.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    ...
                    Whether you're completely new to cybersecurity or have prior
                    CTF experience, there will be challenges suited for you.
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    Expect a full day of hacking, learning, and collaboration.
                    Mentors will be available to provide guidance, and there
                    will be opportunities to network with fellow cybersecurity
                    enthusiasts. Food and refreshments will be provided.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    Join our Discord server to receive the latest announcements
                    about the event, including the official date, registration
                    details, and any preparation resources we'll share before
                    the hackathon.
                  </p>
                </div>
              </div>
        ...
        >
          <div className="max-w-4xl mx-auto px-6">
            <div className="flex items-center justify-center gap-3 mb-4">
              <span className="text-blue-600 dark:text-matrix neon-text-subtle text-lg">
                $
              </span>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-center mb-10 max-w-2xl mx-auto">
              Our CTF features three tracks designed for different skill sets
              and interests.
            </p>
